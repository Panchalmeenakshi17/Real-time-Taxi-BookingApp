...
const GetStarted = ({navigation}) => {
  ...
  return (
    ...
    {/* Background Image */}
      ...
      <Image
        source={require('../../assets/app_images/me2.png')}
        style={styles.backgroundImage}
      />
 
      <Image
      source={require('../../assets/app_images/placeholder.png')}
      style={styles.Image}
      />
      <Image
            source={require('../../assets/app_images/text.png')}
            style={styles.Image2}
          />

          <Image
            source={require('../../assets/app_images/agent.png')}
            style={styles.Image3}
          />

          <Image
          source={require('../../assets/app_images/telephone.png')}
          style={styles.Image4}
          />
        </View>
        </View>
